...
const getBadgetQuantity = () => {
  ...
  return (
    ...
    <Box>
      ...
      <Card  sx={{ width: 200, mr: 2, mt: 3, maxHeight: 280, borderRadius: 3, backgroundColor: 'info2.main' }}>
        ...
        <CardActions>
          ...
          <Box xs={{ maxWidth: 180 }} sx={{  height: 25, display:'flex', justifyContent:'space-around'}} >
            <AddCart stock={getStock()} onAdd={onAdd} initial={-0} />
            <Button ref={productsContainerRef}  color={'info'} size="small" sx={{mr:'4%'}} variant="contained"
              onClick={goTo}
