  ...
  return (
    ...
    <div>
      ...
      <span className="bold">{Valor}</span>
        ...
        <Button size="small" sx={{ mr: 1 }} variant="contained" color='secondary' className="agregar" onClick={() => onAdd(Valor, setValor(0))} onClickCapture={Valor ? openPopover   : null} >Agregar</Button>
             </div>    
    <Popover
    open={Boolean(anchor)}
    anchorEl={anchor}
